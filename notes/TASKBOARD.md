...
| F5 | Data integrity: no fabricated roles in AfA import path, remove auto-import magic, gate legal autofills | qa-pending | worker done: unknown-role placeholder in import paths (no overwrite of real roles), no hardcoded C:/Data auto-import magic, --import-summary requires path (exit 2), legal questions marked-for-review instead of Ja/Nein, role-less cover letter arg; 45 tests green (3 new) |
